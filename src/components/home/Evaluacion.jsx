                    ...
                    return (
                        <div className="col-xs-12 col-sm-12 col-md-6 col-lg-2 col-xl-2 col-col-xxl-2 my-2">
                            <div onClick={() => dispatch(crearAResena(usuario))} className='bg-transparent d-flex flex-column' style={{width: '100%', height: 'auto', borderRadius: '10px'}}>
                                ...
                                <img src="https://cdn.pixabay.com/photo/2019/11/03/20/11/portrait-4599553_960_720.jpg" className='img-fluid' style={{cursor: 'pointer', borderRadius: '20px', opacity: (AResena?.includes(usuario)) && 0.5}} alt="" />
                                <div className='p-2'>
                                    <h5 className='text-white text-center'>{usuario?.name} {usuario?.lastName}</h5>
