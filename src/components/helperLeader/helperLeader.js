...
export const ReseñasfiltradasTodosMeses = (resena, SumaResenasPorMes, showThreeMonth, showThreeMonths, showAllMonth, calificacionPorMeses, changeDate, changeDateRange, usuariosParaAdminLeader) => {
    const MonthFilter = (index, resena) => {
        ...
        let sinAlphabet = sinAlphabet0?.filter(usuario => usuariosParaAdminLeader?.some(usuarios => usuarios?.id === usuario?.id))
...
export const ReseñasfiltradasTodosMesesMayorQue = (resena, SumaResenasPorMes, showThreeMonth, showThreeMonths, showAllMonth, calificacionPorMeses, changeDate, changeDateRange, usuariosParaAdminLeader) => {
...
export const ReseñasfiltradasTodosMesesMayorQueD = (resena, SumaResenasPorMes, showThreeMonth, showThreeMonths, showAllMonth, calificacionPorMeses, changeDate, changeDateRange, usuariosParaAdminLeader) => {
...
export const ReseñasfiltradasTodosMesesMayorQueDUsuarioEquipo = (resena, SumaResenasPorMes, showThreeMonth, showThreeMonths, showAllMonth, calificacionPorMeses, changeDate, changeDateRange, usuariosParaAdminLeader, usuarioFiltrado) => {
...
export const ReseñasfiltradasTodosMesesMayorQueMenor = (resena, SumaResenasPorMes, showThreeMonth, showThreeMonths, showAllMonth, calificacionPorMeses, changeDate, changeDateRange, usuariosParaAdminLeader) => {
...
export const ReseñasfiltradasTodosMesesMayorQueMenorUsuarioEquipo = (resena, SumaResenasPorMes, showThreeMonth, showThreeMonths, showAllMonth, calificacionPorMeses, changeDate, changeDateRange, usuariosParaAdminLeader, usuarioFiltrado) => {
