...
export const CardsAdmin = ( { resenasFiltradas, mes, calificacionPorMeses, show, respWidth, changeShowResena, setChangeShowResena, defineds, changeDate, changeDateRange, showThisWeek, showLastWeek, showThreeMonth, showAllMonth, onlyThreeMonths, usuariosParaAdminLeader, evaluacionFiltradaPorRango, evaluacionFiltroTodosLosMeses, evaluacionCount, isLoading } ) => {
  ...
  return (
    <>
      ...
      <div className="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6 my-2">
        <div onTouchStart = {(e) => onDoubleTap(e, handledActive)} onDoubleClick={handledActive} className={`shadow ${(respWidth > 610) ? 'p-4' : 'p-1'}`} style={{borderRadius: '35px', cursor: 'pointer', height: (respWidth < 610) ? 'auto' : '100%'}}>
