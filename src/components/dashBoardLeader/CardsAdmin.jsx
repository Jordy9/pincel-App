...
export const CardsAdmin = ( { resenasFiltradas, mes, calificacionPorMeses, show, respWidth, changeShowResena, setChangeShowResena, defineds, changeDate, changeDateRange, showThisWeek, showLastWeek, showThreeMonth, usuariosParaAdminLeader } ) => {
  ...
  sinAlphabet = FiltroCalificacionResena?.filter(usuario => usuariosParaAdminLeader?.some(usuarios => usuarios?.id === usuario?.id))
    ...
    <>
      ...
      <div className="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6 my-2">
        <div className={`shadow ${(respWidth > 610) ? 'p-4' : 'p-1'}`} style={{borderRadius: '35px'}}>
          ...
          <h6 className='text-center'>Total de reseñas {sinAlphabet?.length || 0}</h6>
